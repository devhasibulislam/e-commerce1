...
const ProfileSubmenu = () => {
  ...
  return (
    <>
      <div
        className={`flex flex-col gap-y-4 bg-white border border-[#009f46] shadow-lg p-4 rounded-lg absolute top-full right-[50%] z-50`}
      >
        {profileOptions.map((profileOption, index) => (
          <Link
            key={index}
            href={profileOption.anchor}
        ...
        <p
          className="flex gap-x-2 shadow px-4 py-2 hover:shadow-lg cursor-pointer"
          onClick={() => {
