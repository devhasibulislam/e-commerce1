...
const Register = () => {
  const [allowRegisterState, setAllowRegisterState] = useState(true);
        ...
        <div className="p-4 py-6 text-white bg-secondary md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
          ...
          <p className="flex flex-col items-center justify-center mt-10 text-center">
            ...
            <Link
              ...
              data-tip="Login as an existing user"
            >
              Login here!
            </Link>
          </p>
          ...
          <form action="#" className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col space-y-1">
              ...
              <input
                ...
                id="avatar"
                name="avatar"
                className="file-input file-input-md file-input-bordered file-input-secondary rounded"
                required
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onClick={() => setAllowRegisterState(!allowRegisterState)}
              />
              <label
                for="remember"
                className="text-sm font-semibold text-gray-500"
