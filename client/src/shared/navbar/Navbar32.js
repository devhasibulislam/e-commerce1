    ...
    <section className="py-2 relative">
      <div className="flex justify-between items-center lg:flex-row md:flex-row flex-col lg:gap-y-0 md:gap-y-0 gap-y-4">
        ...
        <div className="flex gap-x-4 lg:w-auto md:w-auto w-80 lg:overflow-hidden md:overflow-hidden overflow-x-scroll">
          <Link to={"/"} className="hover:text-primary flex gap-x-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <Link to={"/"} className="hover:text-primary flex gap-x-2 whitespace-nowrap">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
      ...
      {dropdown && (
        <div className="absolute top-full p-4 shadow-lg rounded w-full bg-white">
          <div className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 gap-4">
            <div className="p-2 rounded shadow-sm hover:shadow hover:border hover:border-primary">
              <Link to={"/"}>
                <Image
                  src={
