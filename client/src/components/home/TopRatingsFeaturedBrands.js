        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-4 lg:gap-y-0 gap-y-8">
          ...
          <div>
            ...
            <CategoryHeader
              ...
              categoryName={"Top Ratings"}
              categorySlug={"top-ratings"}
            />
            <div className="my-8"></div>
            <Carousel visibility={3} products={products} view={"products"} />
          </div>
          ...
          <div>
            ...
            <CategoryHeader
              ...
              categoryName={"Featured Brands"}
              categorySlug={"featured-brands"}
            />
            <div className="my-8"></div>
            <Carousel visibility={3} products={products} view={"products"} />
          </div>
